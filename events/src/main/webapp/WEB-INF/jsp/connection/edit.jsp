...
<div class="home-articles max-width-1 m-auto font2">
	<div class="max-width-1 m-auto mx-1 ">
		...
		<form method="POST" action="/connection/edit" name="connection_form"
			id="connection_form">
			...
			<div class="form-box">
				<label for="category_id"><b>Topic</b></label> 
				<select name="category_id" id="category_id">
					
					<c:forEach items="${listCategories}" var="category">
						<option value="${category.id}" ${category.id == formBeanKey.category_id ? 'selected' : '' } >${category.name }</option>
			...
			<div class="form-box">
				<label for="name"><b>Title</b></label> <input id="name" name="name"
					type="text" placeholder=" title " value="${formBeanKey.name}"
					minlength="3" >
			</div>
